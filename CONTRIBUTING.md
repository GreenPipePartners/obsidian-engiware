...
The plugin targets the public Obsidian 1.8.7 API. Keep runtime code browser-compatible
...
It also attaches the manual-install ZIP and demonstration package.
